# Showboat — Evidence Retained (Reporter Checklist)
...
- [ ] Full ETW investigation folder if available: `investigations/showboat/`
...
| Artifact | Path |
|----------|------|
| Indicators | `investigations/showboat/evidence/published-indicators.csv` |
| Claims | `investigations/showboat/claims/claims-ledger.csv` |
| Gaps | `investigations/showboat/gaps/priority-gaps.csv` |
| IC3 draft (repo) | `reports/showboat/SHOWBOAT_IC3_BRIEF.md` |
| This LE package | `reports/law-enforcement/packages/07-showboat/` |
