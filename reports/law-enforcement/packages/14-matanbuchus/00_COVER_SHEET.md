# Matanbuchus — Law Enforcement Package Cover Sheet (CANDIDATE STUB)

| Field | Value |
|-------|-------|
| **Package ID** | `ETW-MAT-IC3` |
| **Family** | Matanbuchus only (case-isolated) |
| **Status** | `CANDIDATE_COMPARATOR` — **NOT READY TO FILE** |
| **Platform** | Windows |
| **Threat type** | MaaS loader+RAT (Teams/ClickFix; ChaCha20) |
...
| **Primary research orgs** | Multiple vendors |
| **Primary publication window** | Elastic/Checkpoint/community; BelialDemon XSS/Exploit ads |
