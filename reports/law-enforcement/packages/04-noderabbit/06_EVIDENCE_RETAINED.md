# NodeRabbit — Evidence Retained (Reporter Checklist)
...
- [ ] Full ETW investigation folder if available: `investigations/noderabbit/`
...
| Artifact | Path |
|----------|------|
| Indicators | `investigations/noderabbit/evidence/published-indicators.csv` |
| Claims | `investigations/noderabbit/claims/claims-ledger.csv` |
| Gaps | `investigations/noderabbit/gaps/priority-gaps.csv` |
| Lineage note | `shared/lineage/pollcat-noderabbit-lineage-note.md` |
| IC3 draft (repo) | `reports/noderabbit/NODERABBIT_IC3_BRIEF.md` |
| This LE package | `reports/law-enforcement/packages/04-noderabbit/` |
