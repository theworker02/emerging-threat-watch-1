# SynkLoader — Evidence Retained (Reporter Checklist)
...
- [ ] Full ETW investigation folder if available: `investigations/synkloader/`
...
| Artifact | Path |
|----------|------|
| Indicators | `investigations/synkloader/evidence/published-indicators.csv` |
| Claims | `investigations/synkloader/claims/claims-ledger.csv` |
| Gaps | `investigations/synkloader/gaps/priority-gaps.csv` |
| IC3 draft (repo) | `reports/synkloader/SYNKLOADER_IC3_BRIEF.md` |
| This LE package | `reports/law-enforcement/packages/06-synkloader/` |
