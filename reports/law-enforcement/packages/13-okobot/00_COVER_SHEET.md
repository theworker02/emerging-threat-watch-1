# Okobot — Law Enforcement Package Cover Sheet (CANDIDATE STUB)

| Field | Value |
|-------|-------|
| **Package ID** | `ETW-OKO-IC3` |
| **Family** | Okobot only (case-isolated) |
| **Status** | `CANDIDATE` — **NOT READY TO FILE** |
| **Platform** | Multi (vendor-reported) |
| **Threat type** | Multi-payload spyware / loader ecosystem (OkoSpyware alias tracking) |
...
| **Primary research orgs** | Kaspersky |
| **Primary publication window** | Kaspersky (investigation start Jan 2026) |
