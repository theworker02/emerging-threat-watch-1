# MiniFast — Law Enforcement Package Cover Sheet (CANDIDATE STUB)

| Field | Value |
|-------|-------|
| **Package ID** | `ETW-MNF-IC3` |
| **Family** | MiniFast only (case-isolated) |
| **Status** | `CANDIDATE` — **NOT READY TO FILE** |
| **Platform** | Windows |
| **Threat type** | Loader / Zoom installer trust abuse (Nimbus Manticore context) |
...
| **Primary research orgs** | Check Point |
| **Primary publication window** | Check Point May 2026 |
