# Showboat — Family Summary

**Case ID slug:** `showboat`  
**Category:** Linux modular post-exploitation / telecom targeting  
...
Defensive threat-intelligence package for **Showboat**. Indicators below are transcribed from vendor PRIMARY-SOURCE reporting and/or ETW OBSERVED_PASSIVE collection. **Author personal identity / home IP is NOT ESTABLISHED.**

## Indicator counts (this build)

| Class | Count |
|-------|------:|
| Domains / URLs / URI paths (domain-class export) | 3 |
| IPs | 14 |
| Hashes (SHA-256/MD5) | 3 |
| Total published-indicator rows | 26 |
...
- Investigation: `investigations/showboat/`
