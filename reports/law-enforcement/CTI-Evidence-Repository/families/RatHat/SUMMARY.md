# RatHat — Family Summary

**Case ID slug:** `rathat`  
**Category:** Android Accessibility / Wireless ADB RAT  
...
Defensive threat-intelligence package for **RatHat**. Indicators below are transcribed from vendor PRIMARY-SOURCE reporting and/or ETW OBSERVED_PASSIVE collection. **Author personal identity / home IP is NOT ESTABLISHED.**

## Indicator counts (this build)

| Class | Count |
|-------|------:|
| Domains / URLs / URI paths (domain-class export) | 19 |
| IPs | 0 |
| Hashes (SHA-256/MD5) | 1 |
| Total published-indicator rows | 40 |
...
- Investigation: `investigations/rathat/`
