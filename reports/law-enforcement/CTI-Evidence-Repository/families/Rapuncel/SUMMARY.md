# Rapuncel — Family Summary

**Case ID slug:** `rapuncel`  
**Category:** Windows info stealer / GitHub-SEO distribution  
...
Defensive threat-intelligence package for **Rapuncel**. Indicators below are transcribed from vendor PRIMARY-SOURCE reporting and/or ETW OBSERVED_PASSIVE collection. **Author personal identity / home IP is NOT ESTABLISHED.**

## Indicator counts (this build)

| Class | Count |
|-------|------:|
| Domains / URLs / URI paths (domain-class export) | 7 |
| IPs | 6 |
| Hashes (SHA-256/MD5) | 9 |
| Total published-indicator rows | 36 |
...
- Investigation: `investigations/rapuncel/`
