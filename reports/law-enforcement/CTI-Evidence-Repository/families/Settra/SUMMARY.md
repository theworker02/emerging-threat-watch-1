# Settra — Family Summary

**Case ID slug:** `settra`  
**Category:** Enterprise ransomware + operator intrusion  
...
Defensive threat-intelligence package for **Settra**. Indicators below are transcribed from vendor PRIMARY-SOURCE reporting and/or ETW OBSERVED_PASSIVE collection. **Author personal identity / home IP is NOT ESTABLISHED.**

## Indicator counts (this build)

| Class | Count |
|-------|------:|
| Domains / URLs / URI paths (domain-class export) | 1 |
| IPs | 2 |
| Hashes (SHA-256/MD5) | 0 |
| Total published-indicator rows | 16 |
...
- Investigation: `investigations/settra/`
