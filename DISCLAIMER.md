...
- Authors are not affiliated with the malware operators under investigation.
- Do not use this material to attack, harass, or unlawfully access systems or persons.
- Law-enforcement drafts (IC3 / FBI packages under `reports/law-enforcement/`) are **not** automatic submissions. Human review is required before any filing. File **one family per complaint** unless linkage evidence exists.
