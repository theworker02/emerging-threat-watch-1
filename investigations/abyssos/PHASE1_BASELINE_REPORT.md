# Abyssos — Phase 1 Baseline (CANDIDATE STUB)
...
Abyssos is tracked as a **candidate/comparator case folder** so Emerging Threat Watch can host notes, source freeze work, and passive collection seeds without inventing indicators.

| Field | Value |
|-------|-------|
| Family | Abyssos |
| Case code | ABY |
| Disclosure framing | Zscaler Aug 2026 |
...
- CTI stub: `reports/law-enforcement/CTI-Evidence-Repository/families/Abyssos/`
- LE stub package: `reports/law-enforcement/packages/08-abyssos/`
