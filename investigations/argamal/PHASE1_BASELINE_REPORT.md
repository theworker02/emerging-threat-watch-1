# Argamal — Phase 1 Baseline (CANDIDATE STUB)
...
Argamal is tracked as a **candidate/comparator case folder** so Emerging Threat Watch can host notes, source freeze work, and passive collection seeds without inventing indicators.
...
- CTI stub: `reports/law-enforcement/CTI-Evidence-Repository/families/Argamal/`
