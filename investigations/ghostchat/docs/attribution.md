# Attribution metadata — GhostChat

**Storage rule:** Attribution is **metadata**, not directory structure. Nationality/alignment claims do not create folder trees.

| Field | Value |
|-------|-------|
| Claim | Not firmly attributed in PRIMARY; Transparent Tribe romance-lure technique class ASSOCIATION_ONLY |
| Confidence | Low |
| Source | ESET (technique context) |
| Aliases | — |
| Lineage notes | — |
