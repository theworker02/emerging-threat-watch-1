== Introducing HybridPetya: Petya/NotPetya copycat with UEFI Secure Boot bypass – Indicators of Compromise

The blog post on HybridPetya is available on WeLiveSecurity at
https://welivesecurity.com/en/
