...
<p align="center">
  ...
  Defensive research only · Case-isolated packages · Law-enforcement and industry handoff
</p>
...
| Audience | Go to |
|----------|--------|
| **Law enforcement / IC3 investigators** | [`reports/law-enforcement/README.md`](reports/law-enforcement/README.md) · [`MASTER_INDEX.csv`](reports/law-enforcement/MASTER_INDEX.csv) |
| **Cybersecurity vendors / CERT / CTI teams** | [`reports/INDEX.md`](reports/INDEX.md) · [`intelligence/combined_iocs.csv`](intelligence/combined_iocs.csv) · [`RESPONSIBLE_SUBMISSION/`](reports/law-enforcement/RESPONSIBLE_SUBMISSION/) |
| **Full corpus map** | [`reports/INDEX.md`](reports/INDEX.md) |
| **ATT&CK / landscape** | [`reports/landscape/ATTACK_CORPUS_MAP.md`](reports/landscape/ATTACK_CORPUS_MAP.md) · [`EVIDENCE_COMPLETENESS.md`](reports/landscape/EVIDENCE_COMPLETENESS.md) |
...
- Evidence before narrative — claims are ledgered with source class and confidence
- Passive collection by default — no malware execution or C2 contact during research
- Defender and LE utility — summaries, IOC CSVs, ATT&CK maps, STIX where available
- Honest uncertainty — explicit non-authorship defaults when techniques overlap
...
| Independent family case files | A merged “mega-campaign” attribution dump |
...
```
reports/law-enforcement/packages/   Investigator packages (02–05 core + filing records)
